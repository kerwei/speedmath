...
echo ""
echo "=== Setup complete! ==="
echo "IMPORTANT: Open port 8080 in your Aliyun Security Group:"
echo "  ECS Console → Security Groups → Add inbound rule:"
echo "    TCP 8080/8080, Source: 0.0.0.0/0"
echo ""
echo "Next steps:"
echo "  1. Deploy the app via CI/CD pipeline, then:"
echo "     systemctl start speedmath"
echo "     systemctl enable speedmath"
echo "  2. Check status: systemctl status speedmath"
